...
import '../../book_search/screens/book_search_screen.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return user.when(
      data: (user) => Scaffold(
        // appBar: CustomAppBar(context: context, title: 'رف الكتب'),
        appBar: CustomAppBar(
          context: context,
          title: "مكتبتي",
          rightButtonIcon: Icons.search, // Icon for the button on the right
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: ProgressBar(progress: 0.63),
                ),
